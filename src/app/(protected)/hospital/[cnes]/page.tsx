    ...
    <div className="min-h-screen">
          ...
          <Form className="self-center min-w-80 w-fit bg-white flex flex-col p-4 gap-8 rounded-lg">
            ...
            <div className="flex justify-between gap-8">
              <div className="flex flex-col">
                <label htmlFor="n_processo">Numero processo:</label>
                <Field
                  name="n_processo"
              ...
              <div className="flex flex-col">
                <label htmlFor="metodo">IVR/TUNEP:</label>
                <Field
                  component="select"
                  name="metodo"
                ...
                >
                  ...
                  <option value="Ambos">BEST</option>
                </Field>
              </div>

              <div className="flex flex-col">
                <label htmlFor="sistema">SIA/SIH:</label>
                <Field
                  component="select"
                  name="sistema"
                  className="bg-gray-300 rounded h-8 p-2"
            ...
            <div className="flex justify-evenly gap-5">
              ...
              <div className="flex flex-col">
                <label htmlFor="fim_correcao">Data de fim de correção:</label>
                <Field
                  name="fim_correcao"
                  className="bg-gray-300 h-8 rounded p-2"
                  placeholder="YYYY/MM/DD"
              ...
              <div className="flex flex-col">
                <label htmlFor="citacao">Data de citação:</label>
                <Field
                  name="citacao"
                  className="bg-gray-300 h-8 rounded p-2"
                  placeholder="YYYY/MM/DD"
      ...
      <div className="flex flex-col p-10 gap-8">
        <h1 className="xl:text-5xl lg:text-4xl md:3xl text-xl font-bold">
          Hospital: {hp_data.nome_fantasia}
        </h1>
